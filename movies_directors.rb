...
# Working with Nested Data Structures: Construct Insights from an NDS with the []s
# Create a Hash: key => Director's name, key => total gross movies

dire_stats = {}
row = 0

while row < directors.length do
